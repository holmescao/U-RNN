...
The trained U-RNN model weights [Google Cloud](https://drive.google.com/file/d/1tfwRJ3gFFTa0kiziVeo9xXsz0DaaJrJU/view?usp=drive_link) or [Baidu Cloud (access code: urnn)](https://pan.baidu.com/s/1lIkKNMZy2GQqKmYCATtw1w) for `location16` are provided (other locations need to be trained). Please download and put it into the path (`<U-RNN_HOME>/exp/20240202_162801_962166/save_model/checkpoint_939_0.000205376.pth.tar`).
