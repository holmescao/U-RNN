...
> **Requirements:** UrbanFlood24 Lite dataset (Section 2) &nbsp;|&nbsp; ≥ 8 GB VRAM &nbsp;|&nbsp; ~3.5 h on RTX 4090 (1000 epochs)
...
> **Requirements:** LarNO dataset (Section 2) &nbsp;|&nbsp; ≥ 8–16 GB VRAM &nbsp;|&nbsp; 2–25 h on RTX 4090
...
2. **Scenario B** — train on the lightweight dataset (~3.5 h) to confirm the training pipeline works end-to-end.
