...
convgru_encoder_params = [
    [
        OrderedDict({
            ...
            "conv1_leaky_3": [16, 16, encoder_filter_size, 1, 0],
        }),
        OrderedDict({
            "conv2_leaky_1": [64, 64, encoder_filter_size, 1, 0],
            "conv2_leaky_2": [64, 64, encoder_filter_size, 1, 0],
            "conv2_leaky_3": [64, 64, encoder_filter_size, 1, 0],
            "avgpool": [2, 2, 0]
        }),
        OrderedDict({
            "conv3_leaky_1": [96, 96, encoder_filter_size, 1, 0],
            "conv3_leaky_2": [96, 96, encoder_filter_size, 1, 0],
            "conv3_leaky_3": [96, 96, encoder_filter_size, 1, 0],
            "avgpool": [2, 2, 0]
        }),
    ],
    [
...
convgru_decoder_params = [
    [
        OrderedDict({
            "deconv1_leaky_1": [96, 96, decoder_filter_size + 1, 2, 0],
            "conv1_de_leaky_2": [96, 96, decoder_filter_size, 1, 0],
            "conv1_de_leaky_3": [96, 96, decoder_filter_size, 1, 0],
        }),
        OrderedDict({
            "deconv2_leaky_1": [96, 96, decoder_filter_size + 1, 2, 0],
            "conv2_de_leaky_2": [96, 96, decoder_filter_size, 1, 0],
            "conv2_de_leaky_3": [96, 96, decoder_filter_size, 1, 0],
        }),
        OrderedDict({
            "conv3_leaky_1": [64, 64, decoder_filter_size, 1, 0],
            "conv3_de_leaky_2": [64, 64, decoder_filter_size, 1, 0],
            "conv3_de_leaky_3": [64, 16, decoder_filter_size, 1, 0],
        }),
    ],
    [
        CGRU_cell(use_checkpoint=use_checkpoint,
