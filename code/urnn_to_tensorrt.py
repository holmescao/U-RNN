...
from src.lib.utils.net_config import get_input_channels


def build_engine(onnx_file_path, engine_file_path, input_channels=63,
    ...
    with trt.Builder(TRT_LOGGER) as builder, \
        ...
        input_shape = (1, 1, input_channels, input_height, input_width)
...
def test(args, device, testLoader, cur_epoch=99999):
    ...
    with torch.no_grad():
        ...
        for i, (inputs, _, _) in enumerate(batch):
            ...
            input_channels = get_input_channels(args.net_cfg, args.historical_nums)
