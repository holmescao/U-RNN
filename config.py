...
# CUDA_VISIBLE_DEVICES=1,2,3,4,5,6,7 python -m torch.distributed.launch --nproc_per_node=7 main_w_cls.py --device 1,2,3,4,5,6,7
...
def ArgumentParsers(
    ...
    parser.add_argument(
        "-seq_num", default=24, type=int, help="sequence number per iteration"
    )
    parser.add_argument(
